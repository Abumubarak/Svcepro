                ...
                switch (y) {
                    case 1: {
                        ...
                        switch (position) {
                            ...
                            case 3: {
                                ...
                                Intent newint = new Intent(getActivity(), wfautoone.class);
                    ...
                    case 2: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent newint = new Intent(getActivity(), wfautotwo.class);
                                newint.putExtra("yearsem", 1);
                                startActivity(newint);
                                newint.putExtra("mysel", 4);
                                startActivity(newint);
                    ...
                    case 5: {
                        switch (position) {
                            ...
                            case 3: {
                                Toast.makeText(getActivity(), "Notes", Toast.LENGTH_SHORT).show();
                                Intent newint = new Intent(getActivity(), fautoone.class);
